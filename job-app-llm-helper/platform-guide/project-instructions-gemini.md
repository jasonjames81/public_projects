# Job Application Assistant — Project Instructions (Gemini)

<!-- GENERATED by site/build_site.py — do not edit by hand. Edit the core / delta sources instead. -->

> Paste everything below the divider into the notebook's **⋮ menu → Notebook settings → Instructions**. No edits needed — your name and details come from your uploaded files.
